...
## Web Applications
- **New**  [Foliage Phenology Exploration Toolkit v0.1]([https://code.earthengine.google.com/#](https://ee-marcelluscampes.projects.earthengine.app/view/foliage-phenology-inspection-tool)) - Recently created, requires 2nd method to be implimented. Web application is very new and is still under development.
